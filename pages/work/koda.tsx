...
export default function Koda() {
  return (
    <>
      ...
      <section>
        <p className="my-2">
          Koda, short for kodawari, a Japanese word roughly meaning "the pursuit
          of perfection", is a coffee company aimed at bridging the gap between
          coffee farmers and coffee consumers. The company was dreampt up by a
          friend of mine which led me to create a 3 page app intro that gives
          users a basic understanding of what Koda is and how it works.
        </p>
      </section>
      <Video src="/koda.mp4" autoPlay parentClasses="w-3/4 md:w-1/2 my-8 mx-auto" />
      <p className="my-2">
